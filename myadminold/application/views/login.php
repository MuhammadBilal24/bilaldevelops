        ...
        <div class="row h-100">
            ...
            <!-- <div class="auth-logo" >
                    ...
                    <form action="" method="post">
                        <div class="form-group position-relative has-icon-left mb-4" style="border:1px #0d3f50 solid;">
                        ...
                        <div class="form-check form-check-lg d-flex align-items-end" >
                            <input class="form-check-input me-2" style="border:1px #0d3f50 solid;" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label text-gray-600" for="flexCheckDefault">
                                Keep me logged in
                            </label>
                        </div>
                        <button type="submit" style="background-color:#0d3f50;color:white;" class=" btn-block btn-lg  mt-5">Log in</button>
                    </form>
