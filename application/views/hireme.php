...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" data-spy="affix" data-offset-top="0">
        <div class="container">
            <a class="" href="Home" style="background-color:white;"><img src="assets/imgs/logo22.png"
    ...
    <section class="position-relative section" >
        <!-- style="background-image: url('assets/imgs/footer-bg.png');background-repeat: no-repeat;background-position: right, left;" -->
        <div class="container text-center">
            ...
            <div class="contact text-left">
                <div class="form">
                    ...
                    <p style="margin-top: -20px;">OR <br> Visit My <a href="https://www.fiverr.com/muhammad_bilals"
                            style="color:green; font-size:larger">Fiverr</a> Account</p>
                    <form id="insertform">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="hemail" name="hemail"
                                aria-describedby="emailHelp" placeholder="Email or Username" required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" id="hsubject" name="hsubject"
                                placeholder="Subject" required>
                        </div>
                        <div class="form-group">
                            <textarea type="text" id="habout" name="habout" cols="30" rows="5" class="form-control"
                ...
                <div class="contact-infos">
                    ...
                    <div class="item">
                        ...
                        <div class="mb-0">
                            <h5>Email Address</h5>
                            <p>Muhammadbilalshaikh00@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="page-footer font-small blue"  style="margin-top:0px">

        <!-- Copyright -->
        <div class="footer-copyright text-center py-3">Copyright
            <script>
                document.write(new Date().getFullYear())
            </script> &copy; <a href="http://www.nenosofts.pk/bilaldevelops"
                target="_blank">BilalDevelops</a>
        </div>
        <!-- Copyright -->
    ...
    <!-- <script src="ajax_cdns/ajax1.js"></script>
 <script src="ajax_cdns/ajax2.js"></script>
 <script src="ajax_cdns/ajax3.js"></script> -->
    <!-- <script src="assets/vendors/bootstrap/bootstrap.affix.js"></script> -->
