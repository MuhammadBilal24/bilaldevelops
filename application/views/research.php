  ...
  <div class="container py-5  ">
    <div class="row ">
      <div class="col-12 col-lg-10 mx-auto">
        <a class="text-primary" style="color:#0d3f50" href="#">Research Paper</a>
        <h2 class="mb-3" style="color:black">Artificial Intelligence in Web Development</h2>
        <div class="d-flex justify-content-between mb-5">
          <div class="d-flex align-items-center">
            <p class="card-text small">Feb 15, 2024</p>
          </div>
        ...
        <img src="assets/imgs/airesearch1.png" alt="Research Paper" class="img-fluid mb-3 py-3">
        <div class="content">
          <p  class="py-2">
          ...
          <a href=""> <button class="btn btn-dark rounded">DOWNLOAD</button></a>
        </div>
        <!-- <div class="comment-area">
          <form action="#" class="row">
            <div class="col-12">
              <label for="LEAVE A REPLAY" class="text-uppercase mb-2">Comment</label>
