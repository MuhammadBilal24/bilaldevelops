...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    <!--  background-image: url("https://nenosofts.pk/bilaldevelops/assets/homesvg.gif");
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" data-spy="affix" data-offset-top="0">
        <div class="container">
            <a class="" href="Home" style="background-color:white;"><img src="assets/imgs/logo22.png"
                    style="margin-right:100%;  width:170px; height:36px " alt=""> </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto align-items-center"><br>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#testmonial">Sales Expertise</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#papers">Research Work</a>
                    </li>
                    <li class="nav-item">
